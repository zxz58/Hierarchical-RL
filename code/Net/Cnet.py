...
class Cnet(nn.Module):
    ...
    def __init__(self,region_num):
        ...
        self.lin_2 = nn.Linear(in_features=128, out_features=256, bias=True)
        self.lin_3 = nn.Linear(in_features=256, out_features=region_num, bias=True)

        self.cov1=nn.Conv1d(in_channels=7,out_channels=16,kernel_size=5,stride=1,padding=2,bias=True)
